...
export const ITEMS: readonly ItemDef[] = [
  ...
  // PR-109 — seed item 제거 (씨앗 자원 폐기).
  {
    ...
    effect: "50개 사용 시 캔디 당근 1개 (또는 토끼 만나기 비용)",
    usable: true,
    minToUse: 50,
  ...
  },
  {
    ...
    effect: "다음 수확 황금당근 확률 +5%p (1회, 당근주스의 황금 버전)",
    usable: true,
    acquisition: "오늘의 선물상자 / 농장 드랍",
  },
  {
    ...
    effect: "다음 포커스 완료 시 모든 농장 보상 1.5배 (1회, 5분 미만 제외)",
    usable: true,
    acquisition: "오늘의 선물상자 / 농장 드랍",
  },
  ...
  // ── tokens (special, ad-watch / shop currency) ──────────────────
  {
    ...
    effect: "100개 모으면 전설 토끼 1마리",
    usable: false,
    acquisition: "수확 보너스 / 보물상자 / 농장 드랍",
  },
  {
    code: "gem",
    ko: "보석",
